...
TARGET_SYSTEM_PROP += device/hardkernel/common/build/rockchip/rksdk.prop
...
PRODUCT_COPY_FILES += \
    device/hardkernel/common/permissions/rockchip.software.display.xml:system/etc/permissions/rockchip.software.display.xml
endif
