...
PRODUCT_COPY_FILES += \
   ...
   $(call find-copy-subdir-files,"*.ko",$(TOPDIR)$(TARGET_KERNEL_SOURCE)/drivers/net/wireless/rockchip_wlan,$(PRODUCT_OUT)/$(TARGET_COPY_OUT_RECOVERY)/root/pcba/lib/modules) \
